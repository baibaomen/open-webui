							...
							<div class="flex items-center justify-between w-full">
								<Tooltip content={$i18n.t('Regenerate')} placement="bottom">
									<button
										type="button"
										class="{isLastMessage
											? 'flex items-center justify-center gap-2 text-sm visible'
											: 'flex items-center justify-center gap-2 text-sm invisible group-hover:visible'} p-1.5 hover:bg-black/5 dark:hover:bg-white/5 rounded-lg dark:hover:text-white hover:text-black transition regenerate-response-button"
										on:click={() => {
